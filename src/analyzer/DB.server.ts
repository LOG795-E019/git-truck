...
export default class DB {
  ...
  public async getAuthorContribsForPath(path: string, isblob: boolean, metricType: string) {
  ...
  public async getAuthorContribsForExtension(path: string, extension: string, metricType: string) {
  ...
  public async getAuthorContribsForKeyword(path: string, extension: string, metricType: string) {
  ...
  public async getAuthorCommitsAndLinesForPath(
    author: string,
    path: string,
    isBlob: boolean
  ): Promise<{ commits: number } | null> {
  ...
  public async getAuthorsFileStats(): Promise<
    Record<string, Record<string, { nb_commits: number; nb_line_change: number }>>
  > {
    const res = await this.query(`
